...
if __name__ == "__main__":
    ...
    print("================================================")
    print("Getting datapacks from curseforge")
    print("================================================")
    links = get_download_links("download_lists/datapacks.org", "[curseforge_download_link]")
    for link in links:
        download_curseforge(link, mods_file)

    print("================================================")
    print("Getting datapacks from modrinth")
    print("================================================")
    links = get_download_links("download_lists/datapacks.org", "[modrinth_download_link]")
    for link in links:
        download(link, mods_file)
    command = "cp -r datapacks custom_configuration/config/paxi/datapacks"
    result = subprocess.run(command, shell=True, capture_output=True, text=True)
